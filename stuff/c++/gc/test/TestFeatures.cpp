...
namespace testInteriorPointer
{
#include "InteriorPointer.hpp"
}

namespace testReturnReference
{
#include "ReturnReference.hpp"
}

namespace testCircularGarbage
{
#include "CircularGarbage.hpp"
}

namespace testMandatoryDelete
{
#include "MandatoryDelete.hpp"
}

namespace testReclaimOrdering
{
#include "ReclaimOrdering.hpp"
}

namespace testResurrection
{
#include "Resurrection.hpp"
}

namespace testRecursiveGC
{
#include "RecursiveGC.hpp"
}

namespace testGCAtExit
{
#include "GCAtExit.hpp"
}
...
#define Test(x)         do { \
      printf ("=== testing " # x "===\n"); \
      retval += test ## x::TestMain (); \
  } while (0)
  Test (InteriorPointer);
  Test (ReturnReference);
  Test (CircularGarbage);
  Test (MandatoryDelete);
  Test (ReclaimOrdering);
  Test (Resurrection);
  Test (RecursiveGC);
  Test (GCAtExit);
#undef Test
